...
func (s *SmartContract) InitLedger(ctx contractapi.TransactionContextInterface) error {
	assets := []Asset{
		...
		{ID: "asset3", Owner: "Spike", Value: 300},
	}
...
func main() {
	...
	if err != nil {
		fmt.Printf("Error create secured_asset_transfer chaincode: %v", err)
		return
	}

	if err := chaincode.Start(); err != nil {
		fmt.Printf("Error starting secured_asset_transfer chaincode: %v", err)
	}
}
